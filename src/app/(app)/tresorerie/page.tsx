      ...
      <div className="grid gap-6 lg:grid-cols-[320px_1fr]">
        <div className="order-2 space-y-6 lg:order-1">
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
            <h3 className="mb-3 text-sm font-semibold text-slate-800">Catégories</h3>
        ...
        <div className="order-1 overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm lg:order-2">
