...
function requete(token: string | undefined, body?: unknown): NextRequest {
  ...
  return new NextRequest(
    "http://localhost/api/internal/n8n/dossiers-a-verifier/dos1/notifie-echec",
...
describe("POST /api/internal/n8n/dossiers-a-verifier/[dossierAnnuelId]/notifie-echec", () => {
  ...
  it("enregistre l'échec", async () => {
    ...
    expect(updateMany).toHaveBeenCalledWith({
      where: { id: "dos1" },
      data: {
        notificationVerificationErreurLe: expect.any(Date),
        notificationVerificationErreurMessage: "550 mailbox unavailable",
      },
    });
  });
