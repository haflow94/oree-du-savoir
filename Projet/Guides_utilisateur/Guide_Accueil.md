...
2. Renseignez votre **Email** et votre **Mot de passe**, puis cliquez sur **Se connecter**.
   ...
   ![écran de connexion avec les champs Email et Mot de passe](images/accueil-01-connexion.png)

3. Vous arrivez sur le **Tableau de bord**, avec le menu de navigation sur la gauche (Étudiants, Présences, Calendrier, Activités…).

   ![menu de navigation visible sur la gauche de l'écran](images/accueil-02-menu-navigation.png)
...
4. Cliquez sur **Rechercher**.
   ...
   ![page Étudiants avec la barre de recherche et les filtres](images/accueil-03-page-etudiants.png)
...
5. La section **Situation financière** indique, pour chaque année scolaire, le montant **Dû**, le **Reste** à payer et le **Statut** du dossier.
   ...
   ![section Situation financière de la fiche étudiant](images/accueil-06-situation-financiere.png)
...
2. Changez la **Date** en haut de la page pour consulter un autre jour.
   ...
   ![page Présences avec la liste des séances du jour](images/accueil-07-presences-jour.png)
...
2. Vous voyez le statut de chaque étudiant (Présent, Retard, Retard excusé, Absent, Absent excusé), ainsi que la date et l'heure de validation et le nom de la personne qui a validé.
   ...
   ![feuille de présence consultée en lecture, avec le récapitulatif des statuts](images/accueil-08-feuille-presence-lecture.png)
