...
1. Avec l'appareil photo de votre téléphone (ou une application de lecture de QR code), scannez le QR code affiché dans la salle.
   ...
   ![QR code affiché en salle, tel qu'imprimé ou affiché sur un écran](images/enseignant-01-qr-code.png)
...
1. Vous voyez le nom de la classe, la date et l'horaire de la séance, ainsi que la liste de tous les élèves inscrits.
   ...
   ![écran Appel du jour avec le titre de la classe et la liste des élèves](images/enseignant-03-appel-du-jour.png)
...
3. Pour changer le statut d'un élève, cliquez sur le bouton correspondant à côté de son nom :
   ...
   ![ligne d'un élève avec les 5 boutons de statut, l'un d'eux sélectionné](images/enseignant-04-ligne-statut.png)
...
6. Une fois tous les statuts vérifiés, cliquez sur **Valider l'appel**.
   ...
   ![bouton Valider l'appel en bas de l'écran](images/enseignant-05-valider-appel.png)
...
7. Une fois validé, un message vert confirme **« Appel validé »**, avec la date, l'heure et votre nom.
   ...
   ![message de confirmation « Appel validé » en haut de la page](images/enseignant-06-confirmation-validee.png)
...
![page Présences affichant « Vos séances du jour »](images/enseignant-07-presences-jour.png)
